        ...
        },
        {
            ...
            'steps': [
                _create_step(
                    '烟感火警',
                    2,
                    _create_object('component_status', {'componentType': 42, 'componentStatus': 2, 'bitNo': 1, 'zoneNo': 1, 'description': 'A区1层大厅烟感01'}),
                    delay_after_sec=3,
                ),
                _create_step(
                    '联动反馈',
                    2,
                    _create_object('component_status', {'componentType': 86, 'componentStatus': 64, 'bitNo': 1, 'zoneNo': 1, 'description': '联动模块反馈'}),
                    delay_after_sec=5,
                ),
            ],
        },
        {
            ...
            'steps': [
                _create_step(
                    '联动启动',
                    2,
                    _create_object('component_status', {'componentType': 86, 'componentStatus': 32, 'bitNo': 1, 'zoneNo': 1, 'description': '联动模块启动'}),
                    delay_after_sec=3,
                ),
                _create_step(
                    '联动反馈',
        ...
        },
        {
            ...
            'steps': [
                ...
                _create_step(
                    '烟感恢复',
                    2,
                    _create_object('component_status', {'componentType': 42, 'componentStatus': 0, 'bitNo': 1, 'zoneNo': 1, 'description': 'A区1层大厅烟感01恢复'}),
                    delay_after_sec=5,
                ),
            ],
        },
        {
            ...
            'steps': [
                _create_step(
                    '部件监管',
                    2,
                    _create_object('component_status', {'componentType': 42, 'componentStatus': 16, 'bitNo': 1, 'zoneNo': 1, 'description': 'A区1层烟感监管'}),
                    delay_after_sec=5,
                ),
                _create_step(
                    '部件恢复',
                    2,
                    _create_object('component_status', {'componentType': 42, 'componentStatus': 0, 'bitNo': 1, 'zoneNo': 1, 'description': 'A区1层烟感恢复'}),
                    delay_after_sec=5,
                ),
            ],
        },
