...
SYSTEM_STATUS_BITS = [
    ...
    {'label': '保留位7', 'on': 'bit7=1', 'off': 'bit7=0'},
    {'label': '主电故障', 'on': '主电故障', 'off': '主电正常'},
    {'label': '备电故障', 'on': '备电故障', 'off': '备电正常'},
    {'label': '总线故障', 'on': '总线故障', 'off': '总线正常'},
    {'label': '手动/自动', 'on': '手动', 'off': '自动'},
    {'label': '配置改变', 'on': '配置改变', 'off': '配置未变更'},
    {'label': '复位', 'on': '复位', 'off': '未复位'},
    {'label': '测试运行', 'on': '测试运行', 'off': '正常运行'},
    {'label': '停机', 'on': '停机', 'off': '正常运行'},
]
...
COMPONENT_STATUS_BITS = [
    ...
    {'label': '配置改变', 'on': '配置改变', 'off': '配置未变更'},
    {'label': '测试运行', 'on': '测试运行', 'off': '正常运行'},
    {'label': '保留位14', 'on': 'bit14=1', 'off': 'bit14=0'},
    {'label': '保留位15', 'on': 'bit15=1', 'off': 'bit15=0'},
]

DEVICE_STATUS_BITS = [
    {'label': '运行模式', 'on': '测试状态', 'off': '正常监视状态'},
    {'label': '火警', 'on': '火警', 'off': '无火警'},
    {'label': '故障', 'on': '故障', 'off': '无故障'},
    {'label': '主电故障', 'on': '主电故障', 'off': '主电正常'},
    {'label': '备电故障', 'on': '备电故障', 'off': '备电正常'},
...
FACILITY_OPERATION_BITS = [
    {'label': '测试', 'on': '测试', 'off': '未测试'},
    {'label': '自检', 'on': '自检', 'off': '未自检'},
    {'label': '警情消除', 'on': '警情消除', 'off': '未消除'},
    {'label': '手动报警', 'on': '手动报警', 'off': '无手动报警'},
    {'label': '消音', 'on': '消音', 'off': '未消音'},
    {'label': '复位', 'on': '复位', 'off': '未复位'},
    {'label': '启停操作', 'on': '启停操作', 'off': '无启停操作'},
    {'label': '保留位7', 'on': 'bit7=1', 'off': 'bit7=0'},
]

DEVICE_OPERATION_BITS = [
    {'label': '测试', 'on': '测试', 'off': '未测试'},
    {'label': '查岗应答', 'on': '查岗应答', 'off': '无查岗应答'},
    {'label': '自检', 'on': '自检', 'off': '未自检'},
    {'label': '警情消除', 'on': '警情消除', 'off': '未消除'},
    {'label': '手动报警', 'on': '手动报警', 'off': '无手动报警'},
    {'label': '消音', 'on': '消音', 'off': '未消音'},
