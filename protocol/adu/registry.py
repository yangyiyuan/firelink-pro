...
PARSER_REGISTRY: Dict[int, Parser] = {
    ...
    134: lambda reader, info_count, type_flag, type_flag_name: parse_system_status_objects(reader, info_count, type_flag, type_flag_name),
    135: lambda reader, info_count, type_flag, type_flag_name: parse_component_status_objects(reader, info_count, type_flag, type_flag_name),
